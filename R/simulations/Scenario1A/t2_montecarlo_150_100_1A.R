...
for(i in seq_along(deltas)) 
{
  ...
  for(g in seq_len(mc_chart)) 
  {
    ...
    for(k in seq_len(K))
    {
      ...
      senal_grafico_t2_montecarlo_150_100[k] <- T2 > UCL
    }
    ...
    senal_delta[[g]] <- senal_grafico_t2_montecarlo_150_100
  }
  ...
  senal_t2_montecarlo_150_100[[i]] <- unlist(senal_delta)
...
save(
  ...
  file = "t2_montecarlo_150_100.RData"
)