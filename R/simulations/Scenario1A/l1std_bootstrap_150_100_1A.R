...
senal_l1std_boot_150_100 <- vector("list", length(deltas))

## Object for saving simulation result (power)
potencia_l1std_boot_150_100 <- numeric(length(deltas))
...
save(
  ...
  file = "results/simulations/l1std_boot_150_100_1A.RData"
)
