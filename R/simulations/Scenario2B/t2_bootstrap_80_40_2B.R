...
senal_t2_boot_80_40 <- vector("list", length(etas))

## Object for saving simulation result (power)
potencia_t2_boot_80_40 <- numeric(length(etas))
...
for (i in seq_along(etas)) {
  ...
  senal_t2_boot_80_40[[i]] <- unlist(lapply(senal, function(x) x$s))
  potencia_t2_boot_80_40[i] <- mean(senal_t2_boot_80_40[[i]])
...
save(
  potencia_t2_boot_80_40,
  senal_t2_boot_80_40,
  file = "results/simulations/t2_boot_80_40_2B.RData"
)
