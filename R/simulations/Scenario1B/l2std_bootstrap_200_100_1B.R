...
cat("--- Scenario 1B simulation for L2, Bootstrap,", n1, "/", n2, "\n")
start0 <- Sys.time()
...
save(
  ...
  file = "results/simulations/l2std_boot_200_100_1B.RData"
)
...
cat(
  "[",
  format(end, "%HH:%MM"),
  "] END simulation Scenario 1B for L2, Bootstrap,", n1, "/", n2, "\n",
