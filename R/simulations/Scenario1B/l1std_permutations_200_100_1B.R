...
potencia_l1std_perms_200_100 <- numeric(length(deltas))

## Object for saving simulation result (out of control signal)
senal_l1std_perms_200_100 <- vector("list", length(deltas))
...
save(
  ...
  file = "results/simulations/l1std_perms_200_100_1B.RData"
)
