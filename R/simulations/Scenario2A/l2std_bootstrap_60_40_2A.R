...
senal_l2std_boot_60_40 <- vector("list", length(etas))

## Object for saving simulation result (power)
potencia_l2std_boot_60_40 <- numeric(length(etas))
...
for (i in seq_along(etas)) {
  ...
  senal_l2std_boot_60_40[[i]] <- unlist(lapply(senal, function(x) x$s))
  potencia_l2std_boot_60_40[i] <- mean(senal_l2std_boot_60_40[[i]])
...
save(
  potencia_l2std_boot_60_40,
  senal_l2std_boot_60_40,
  file = "results/simulations/l2std_boot_60_40_2A.RData"
)
